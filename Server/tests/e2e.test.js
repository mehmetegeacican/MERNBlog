...
describe("TESTS FOR BLOG API ENDPOINTS", () => {
  ...
  beforeAll(async () => {
    try {
      ...
      token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NzY2ODBjYjI3NmJhYzhlMDA3ODMyYzMiLCJpYXQiOjE3MzQ3NzA4OTEsImV4cCI6MTczNDg1NzI5MX0.972j3iL3ohWN-AM7QC_nunI-I88kd-rfOjt_vYpKTf4";
